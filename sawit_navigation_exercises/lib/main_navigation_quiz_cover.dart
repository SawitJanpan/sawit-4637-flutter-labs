...
// - Extended quiz app with cover page and named routes navigation
// - Uses Navigator.pushNamed for navigation to quiz
// - Uses Navigator.popUntil for Home button to return to cover
// @author Sawit Janpan
// @version 1.0.0
// @date 2026-03-10
...
class _QuizAppState extends State<QuizApp> {
  ...
  void _showResultDialog() {
    // Final score recalculation before showing result
    _recalculateScore();
